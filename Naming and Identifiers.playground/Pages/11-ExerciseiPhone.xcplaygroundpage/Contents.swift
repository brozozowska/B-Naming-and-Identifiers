...
let megaByte = 1
let gigaByte = 1000
let phoneStorageMB = 8 * gigaByte
let alreadyStoredMB = 3 * gigaByte
let oneMinuteOfVideoMB = 150 * megaByte

let howManyStorage = phoneStorageMB - alreadyStoredMB
let howManyMinutes = howManyStorage/oneMinuteOfVideoMB
/*:
