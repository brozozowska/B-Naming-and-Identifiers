...
let totalTime = brushTeeth + uploadPhotos + chooseClothes + takingShower + goJogging + finishHomework
/*:
 ...
 */
let thingsHaveToDo = brushTeeth + chooseClothes + takingShower
let thingsLikeToDo = uploadPhotos + goJogging
let thingsDontLikeToDo = finishHomework
/*:
